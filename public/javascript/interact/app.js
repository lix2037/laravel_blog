...
// Modify by wecenter
$(document).on('click', '.aw-publish-box .publish-new', function ()
{
    $(this).parents('.aw-publish-splash').hide();
    $(this).parents('.aw-publish-box').find('.aw-publish-form, .modal-footer').show();
});
